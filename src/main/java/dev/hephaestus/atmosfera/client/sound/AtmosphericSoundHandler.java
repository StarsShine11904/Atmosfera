...
public class AtmosphericSoundHandler {
    ...
    public MusicSound getMusicSound(MusicSound original) {
        ...
        float originalWeight = soundManager.get(original.getSound().value().getId()).getWeight(); // TODO soundManager.get() returns null with Music Control...?!
        ...
        return candidates.get(candidates.size() - 1).getRight();
    }
}
